    ...
    <nav class="p-4 ">
      <div class="container mx-auto flex justify-between items-center">
        ...
        <ul id="menu" class="hidden md:flex md:space-x-4 absolute md:static top-16 left-0 w-full md:w-auto md:bg-transparent bg-sky-700 text-center md:text-left">
          <li class="p-3 md:p-0 font-semibold hover:underline"><a href="/service">Servicios</a></li>
          <li class="p-3 md:p-0 font-semibold hover:underline"><a href="/contact">Contacto</a></li>
          <li class="p-3 md:p-0 font-semibold hover:underline"><a href="/login" class="bg-sky-700 text-white px-4 py-2 rounded-3xl transition">Inicia sesión</a></li>
