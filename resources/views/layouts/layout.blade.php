...
<body class="bg-gradient-to-r from-[#5533ff] to-[#27d7f5] text-white font-sans">
  <!-- Navbar -->
  ...
  <div class="w-full max-w-screen-xl mx-auto">
    <nav class="bg-transparent text-white p-4">
      <div class="container mx-auto flex justify-between items-center">
        ...
        <button id="menu-toggle" type="button" class="inline-flex items-center p-2 w-10 h-10 justify-center text-sm text-gray-500 rounded-lg md:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-800 dark:text-black dark:hover:bg-gray-700 dark:focus:ring-gray-800" aria-controls="navbar-default" aria-expanded="false">
        ...
        <!-- Menú de navegación -->
        <ul id="menu" class="hidden md:flex md:space-x-4 absolute md:static top-16 left-0 w-full md:w-auto bg-transparent text-center md:text-left">
          <li class="p-3 md:p-0 hover:bg-gray-700 md:hover:bg-transparent font-semibold"><a href="/service">Servicios</a></li>
          <li class="p-3 md:p-0 hover:bg-gray-700 md:hover:bg-transparent font-semibold"><a href="/contact">Contacto</a></li>
          <li class="p-3 md:p-0 font-semibold"><a href="/login" class="bg-sky-700 text-white px-4 py-2 rounded-3xl transition">Inicia sesión</a></li>
          <li class="p-3 md:p-0 font-semibold"><a href="/login" class="bg-white text-black px-4 py-2 rounded-3xl transition">Registrarse</a></li>
  ...
  <footer class="bg-white dark:bg-gray-900">
      <div class="mx-auto w-full max-w-screen-xl p-4 py-6 lg:py-8">
            ...
            <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-2">
                <div>
                    ...
                    <ul class="text-gray-500 dark:text-gray-400 font-medium">
                        <li class="mb-4">
                            <a href="https://flowbite.com/" class="hover:underline">Catalogo en lnea</a>
                        </li>
                    </ul>
                </div>
                <div>
        ...
        <div class="sm:flex sm:items-center sm:justify-between">
            <span class="text-base text-gray-500 sm:text-center dark:text-gray-400">© 2025 <a href="https://flowbite.com/" class="hover:underline">Tienda Yi-Cell™</a>. Todos los Derechos Reservados.
            </span>
